...
Examples:
1. <code>{escape('<b>Join: @PBX_PERMOT</b>')}</code> 
This will give output as:
<b>Join: @PBX_PERMOT</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @PBX_PERMOT</code>')}</code> 
This will give output as:
<code>Join: @PBX_PERMOT</code> <code>69MB.bin</code>.
